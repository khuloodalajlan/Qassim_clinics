            ...
            <?php if ($rows > 0) {
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 d-none">
                     ...
                     $query = "  approved = 1  ";
                        if (isset($_POST['do']) && $_POST['do'] == 'search') {
                            ...
                            $citys = getrows('SELECT * from citys where id in (SELECT city_id from clinics)');

                            foreach ($citys as $city) {?>
                               <div class="col-lg-12 col-md-12 col-sm-12">
                          <h1 style="text-align: center;">     <?php echo $city['name']?></h1>
                          <hr>
                          </div>

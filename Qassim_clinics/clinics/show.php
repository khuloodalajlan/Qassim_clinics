        ...
        <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="form-group col-sm-12">
                    <?php if (isset($get)) { ?> <img src="../uploads/<?php echo $get['image'] ?>" style="width: 50%;" height="400px" alt="" srcset=""><?php } ?>
                    ...
                    <h4 style="text-align: left;">Location:<b><a class="btn btn-primary" href="<?php if (isset($get)) { ?> <?php echo $get['addresse_link'] ?>" <?php } ?>" target="_blank" rel="noopener noreferrer"><i class="ti-location-pin"></i>Click Here</a>
                        </b>
                    </h4>
                    ...
                    <h4 style="text-align: left;">working hours :<b> <?php if (isset($get)) { ?> <?php echo $get['working_hours'] ?><?php } ?></b></h4>
